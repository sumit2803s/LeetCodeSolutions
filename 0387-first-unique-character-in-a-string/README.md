<h2><a href="https://leetcode.com/problems/first-unique-character-in-a-string/?envType=problem-list-v2&envId=string&status=SOLVED&difficulty=EASY%2CMEDIUM">387. First Unique Character in a String</a></h2><h3>Easy</h3><hr><p>Given a string <code>s</code>, find the <strong>first</strong> non-repeating character in it and return its index. If it <strong>does not</strong> exist, return <code>-1</code>.</p>
