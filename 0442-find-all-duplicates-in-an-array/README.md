<h2><a href="https://leetcode.com/problems/find-all-duplicates-in-an-array/?envType=problem-list-v2&envId=array&difficulty=EASY%2CMEDIUM&status=TO_DO">442. Find All Duplicates in an Array</a></h2><h3>Medium</h3><hr><p>Given an integer array <code>nums</code> of length <code>n</code> where all the integers of <code>nums</code> are in the range <code>[1, n]</code> and each integer appears <strong>at most</strong> <strong>twice</strong>, return <em>an array of all the integers that appears <strong>twice</strong></em>.</p>
